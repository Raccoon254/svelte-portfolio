  ...
  const projects: Project[] = [
    {
      ...
      },
      {
          ...
          description: "A platform for students to buy and sell items within the university. Features include real-time chat, payment processing, and notification systems.",
          image: "market.png",
